...
from product.models import Category, Product, Images, Comment, Duration, Location, Variants
...
class VariantsAdmin(admin.ModelAdmin):
    list_display = ['title','product','duration','location','price','quantity','image_tag']
